...
#     print 'addr = ', addr 
    ...
    ref_bin = "%s/HelloWorld/%s/HelloWorld"%(build_root,os.environ["OUTPUT_DIR"])
    
    if not nobin:
        REF_args = [python_bin,"%s/Gse/bin/pexpect_runner.py"%build_root,"HelloWorld.log","HelloWorld Application",ref_bin,"-p","%d"%used_port,"-a",addr]
