...
HelloWorld::HelloSenderComponentImpl helloSender
#if FW_OBJECT_NAMES == 1
("helloSender")
#endif
;

HelloWorld::HelloReceiverComponentImpl helloReceiver
#if FW_OBJECT_NAMES == 1
("helloReceiver")
#endif
;
...
void constructApp(int port_number, char* hostname) {
	...
	helloSender.regCommands();
	helloReceiver.regCommands();
	...
	helloSender.start(0,100, 10*1024);
