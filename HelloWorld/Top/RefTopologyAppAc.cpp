...
void setHelloWorldIds(void){
	...
	helloSender.setIdBase(1000);
	helloReceiver.setIdBase(1100);
}
...
void constructHelloWorldArchitecture(void) {  
    ...
    //None
    rateGroup1Comp.set_RateGroupMemberOut_OutputPort(3, helloReceiver.get_SchedIn_InputPort(0));
    //None
    ...
    //None
    cmdDisp.set_compCmdSend_OutputPort(20, helloSender.get_CmdDisp_InputPort(0));
    //None
    cmdDisp.set_compCmdSend_OutputPort(21, helloReceiver.get_CmdDisp_InputPort(0));
    //None
    ...
    //None
    helloSender.set_CmdReg_OutputPort(0, cmdDisp.get_compCmdReg_InputPort(20));
    //None
    helloSender.set_CmdStatus_OutputPort(0, cmdDisp.get_compCmdStat_InputPort(0));
    //None
    helloSender.set_Log_OutputPort(0, eventLogger.get_LogRecv_InputPort(0));
    //None
    helloSender.set_LogText_OutputPort(0, textLogger.get_TextLogger_InputPort(0));
    //None
    helloSender.set_Tlm_OutputPort(0, chanTlm.get_TlmRecv_InputPort(0));
    //None
    helloSender.set_Time_OutputPort(0, linuxTime.get_timeGetPort_InputPort(0));
    //None
    helloSender.set_HelloOut_OutputPort(0, helloReceiver.get_HelloIn_InputPort(0));
    //None
    helloReceiver.set_CmdReg_OutputPort(0, cmdDisp.get_compCmdReg_InputPort(21));
    //None
    helloReceiver.set_CmdStatus_OutputPort(0, cmdDisp.get_compCmdStat_InputPort(0));
    //None
    helloReceiver.set_Log_OutputPort(0, eventLogger.get_LogRecv_InputPort(0));
    //None
    helloReceiver.set_LogText_OutputPort(0, textLogger.get_TextLogger_InputPort(0));
    //None
    helloReceiver.set_Tlm_OutputPort(0, chanTlm.get_TlmRecv_InputPort(0));
    //None
    helloReceiver.set_Time_OutputPort(0, linuxTime.get_timeGetPort_InputPort(0));
    //None
    helloReceiver.set_HelloOut_OutputPort(0, helloSender.get_HelloIn_InputPort(0));
