// ======================================================================
// \title  HelloReceiver/test/ut/TesterBase.hpp
// \author Auto-generated
// \brief  hpp file for HelloReceiver component test harness base class
//
// \copyright
...
#ifndef HelloReceiver_TESTER_BASE_HPP
#define HelloReceiver_TESTER_BASE_HPP
...
namespace HelloWorld {
  ...
  //! \class HelloReceiverTesterBase
  //! \brief Auto-generated base class for HelloReceiver component test harness
  //!
  class HelloReceiverTesterBase :
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //! Initialize object HelloReceiverTesterBase
      //!
      virtual void init(
    ...
    public:
      ...
      //! Connect HelloIn to to_HelloIn[portNum]
      //!
      void connect_to_HelloIn(
          const NATIVE_INT_TYPE portNum, /*!< The port number*/
          HelloWorld::InputHelloPort *const HelloIn /*!< The port*/
      );
    ...
    public:
      ...
      //! Get the port that receives input from HelloOut
      //!
      //! \return from_HelloOut[portNum]
      //!
      HelloWorld::InputHelloBackPort* get_from_HelloOut(
          const NATIVE_INT_TYPE portNum /*!< The port number*/
      );
    ...
    protected:
      ...
      //! Construct object HelloReceiverTesterBase
      //!
      ...
      //! Destroy object HelloReceiverTesterBase
      //!
      virtual ~HelloReceiverTesterBase(void);
    ...
    protected:
      ...
      //! Handler prototype for from_HelloOut
      //!
      virtual void from_HelloOut_handler(
          const NATIVE_INT_TYPE portNum, /*!< The port number*/
          I32 helloback 
      ) = 0;

      //! Handler base function for from_HelloOut
      //!
      void from_HelloOut_handlerBase(
          const NATIVE_INT_TYPE portNum, /*!< The port number*/
          I32 helloback 
      );
    ...
    protected:
      ...
      //! Push an entry on the history for from_HelloOut
      void pushFromPortEntry_HelloOut(
          I32 helloback 
      );

      //! A history entry for from_HelloOut
      //!
      typedef struct {
        I32 helloback;
      } FromPortEntry_HelloOut;

      //! The history for from_HelloOut
      //!
      History<FromPortEntry_HelloOut> 
        *fromPortHistory_HelloOut;
    ...
    protected:
      ...
      //! Invoke the to port connected to HelloIn
      //!
      void invoke_to_HelloIn(
          const NATIVE_INT_TYPE portNum, /*!< The port number*/
          I32 hello 
      );
    ...
    public:
      ...
      //! Get the number of to_HelloIn ports
      //!
      //! \return The number of to_HelloIn ports
      //!
      NATIVE_INT_TYPE getNum_to_HelloIn(void) const;

      //! Get the number of from_HelloOut ports
      //!
      //! \return The number of from_HelloOut ports
      //!
      NATIVE_INT_TYPE getNum_from_HelloOut(void) const;
    ...
    protected:
      ...
      //!
      //! Whether to_HelloIn[portNum] is connected
      //!
      bool isConnected_to_HelloIn(
          const NATIVE_INT_TYPE portNum /*!< The port number*/
      );
    ...
    protected:
      ...
      //! Send a SET_RESPONSE command
      //!
      void sendCmd_SET_RESPONSE(
    ...
    protected:
      ...
      //! Handle event HELLO_REPLIED
      //!
      virtual void logIn_ACTIVITY_HI_HELLO_REPLIED(
          I32 helloback /*!< The reply = 2*/
      );

      //! A history entry for event HELLO_REPLIED
      //!
      typedef struct {
        I32 helloback;
      } EventEntry_HELLO_REPLIED;

      //! The history of HELLO_REPLIED events
      //!
      History<EventEntry_HELLO_REPLIED> 
        *eventHistory_HELLO_REPLIED;
    ...
    protected:
      ...
      //! Handle channel NUM_HELLOS
      //!
      virtual void tlmInput_NUM_HELLOS(
          const Fw::Time& timeTag, /*!< The time*/
          const U32& val /*!< The channel value*/
      );

      //! A telemetry entry for channel NUM_HELLOS
      //!
      typedef struct {
        Fw::Time timeTag;
        U32 arg;
      ...
      //! The history of NUM_HELLOS values
      //!
      History<TlmEntry_NUM_HELLOS> 
        *tlmHistory_NUM_HELLOS;
    ...
    protected:
      ...
      //! Handle channel GREET
      //!
      virtual void tlmInput_GREET(
          const Fw::Time& timeTag, /*!< The time*/
          const HelloWorld::Hello& val /*!< The channel value*/
      );

      //! A telemetry entry for channel GREET
      //!
      typedef struct {
        Fw::Time timeTag;
      ...
      //! The history of GREET values
      //!
      History<TlmEntry_GREET> 
        *tlmHistory_GREET;
    ...
    private:
      ...
      //! To port connected to HelloIn
      //!
      HelloWorld::OutputHelloPort m_to_HelloIn[1];
    ...
    private:
      ...
      //! From port connected to HelloOut
      //!
      HelloWorld::InputHelloBackPort m_from_HelloOut[1];
    ...
    private:
      ...
      //! Static function for port from_HelloOut
      //!
      static void from_HelloOut_static(
